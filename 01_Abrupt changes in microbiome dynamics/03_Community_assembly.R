...
dir <- make.dir('01_Abrupt changes in microbiome dynamics/Community assembly')
...
ggsave(plot=plot_grid(plotlist=glist1, nrow=2, byrow=FALSE),
       filename=sprintf('%s/Relative abundance of community structure.pdf', dir$figdir, gsub('/', '_', i)),h=21, w=15)
