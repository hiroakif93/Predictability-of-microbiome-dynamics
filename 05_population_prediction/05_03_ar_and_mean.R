...
dir <- make.dir('05_population_prediction/05_03_output')
...
saveRDS(meanmodels, 'Table/05_03_mean_predicted_community')      
saveRDS(predlist, 'Table/05_03_AR_predicted_community')    
saveRDS(statall, 'Table/05_03_AR_statics')    

plot(na.omit(statall[[1]][,c('AR.rho', 'AR.rmse')]))

table(statall[[1]][,c('AR.rmse')])
