...
statics.all$treat <- factor(statics.all$treat, levels=names(dlist)[-7])
pvalall $treat <- factor(pvalall$treat, levels=names(dlist)[-7])

statics.all$treat <- factor(gsub('medium ', 'Medium-', statics.all$treat), gsub('medium ', 'Medium-', names(dlist)[-7]))
pvalall$treat <- factor(gsub('medium ', 'Medium-', pvalall $treat), gsub('medium ', 'Medium-', names(dlist)[-7]))
